<?php
    class Widget_MCache extends Tiri_Widget{
        ...
        public function add($key , $value ,$expire){
            ...
            return $this -> _memcLink -> add($key , $value , $expire);
        ...
        public function logError($type = ''){
            //Log::assert(__FILE__ ,__LINE__ , $this -> _memcLink -> getResultMessage());
            //echo $this -> _memcLink -> getResultMessage();
            //NK_Log::error(__FILE__ , __LINE__ , $this -> _memcLink->getResultCode() );
            //NK_Log::error(__FILE__ , __LINE__ , $this -> _memcLink->getResultMessage() );
        }
    }
?>